...
void test_struct() {
    ...
    struct Position * temp_posp = DTAB_GETH(dtab_test1, "Test");
    lok(temp_posp == NULL);
    struct Position temp_pos = {.x = 1, .y = 2};
    lok(temp_pos.x == 1);
    lok(temp_pos.y == 2);
    DTAB_ADDH(dtab_test1, &temp_pos, "Test");
    temp_posp = (struct Position *) DTAB_GETH(dtab_test1, "Test");
    lok(temp_posp != NULL);
    ...
    temp_posp2->x = 2;
    temp_posp2->y = 4;
    DTAB_ADDH(dtab_test1, temp_posp2, "Test2");
    temp_posp = DTAB_GETH(dtab_test1, "Test2");
    lok(temp_posp != NULL);
    lok(temp_posp->x == temp_posp2->x);
    lok(temp_posp->y == temp_posp2->y);
    printf("temp_posp %d %d", temp_posp->x, temp_posp->y);
    DTAB_ADDH(dtab_test1, temp_posp2, "Test");
    temp_posp = DTAB_GETH(dtab_test1, "Test");
    lok(temp_posp != NULL);
    lok(temp_posp->x == temp_posp2->x);
    lok(temp_posp->y == temp_posp2->y);

    temp_posp = DTAB_GETH(dtab_test1, DTAB_STRINGIFY(Test));
    lok(temp_posp != NULL);
    lok(temp_posp->x == temp_posp2->x);
    lok(temp_posp->y == temp_posp2->y);

    temp_posp = DTAB_GETSH(dtab_test1, Test);
    lok(temp_posp != NULL);
    lok(temp_posp->x == temp_posp2->x);
    lok(temp_posp->y == temp_posp2->y);
    ...
    temp_posp2->x = 1;
    temp_posp2->y = 1;
    DTAB_ADDH(dtab_test1, temp_posp2, "Test3");

    temp_posp2->x = 2;
    temp_posp2->y = 2;
    DTAB_ADDH(dtab_test1, temp_posp2, "Test4");

    temp_posp2->x = 3;
    temp_posp2->y = 3;
    DTAB_ADDH(dtab_test1, temp_posp2, "Test5");

    temp_posp2->x = 4;
    temp_posp2->y = 4;
    DTAB_ADDH(dtab_test1, temp_posp2, "Test6");

    temp_posp2->x = 5;
    temp_posp2->y = 5;
    DTAB_ADDH(dtab_test1, temp_posp2, "Test7");

    temp_posp2->x = 6;
    temp_posp2->y = 6;
    DTAB_ADDH(dtab_test1, temp_posp2, "Test8");
    ...
    temp_posp2->x = 8;
    temp_posp2->y = 8;
    DTAB_ADDH(dtab_test1, temp_posp2, "Test9");

    temp_posp = DTAB_GETH(dtab_test1, "Test3");
    lok(temp_posp != NULL);

    temp_posp = DTAB_GETH(dtab_test1, "Test4");
    lok(temp_posp != NULL);

    temp_posp = DTAB_GETH(dtab_test1, "Test5");
    lok(temp_posp != NULL);

    temp_posp = DTAB_GETH(dtab_test1, "Test6");
    lok(temp_posp != NULL);
    ...
    temp_posp = DTAB_GETH(dtab_test1, "Test8");
    lok(temp_posp != NULL);
    lok(temp_posp->x == 7);
    lok(temp_posp->y == 7);
    ...
    temp_posp2->x = 9;
    temp_posp2->y = 9;
    DTAB_ADDH(dtab_test1, temp_posp2, "Test10");
    temp_posp2->x = 9;
    temp_posp2->y = 9;
    DTAB_ADDH(dtab_test1, temp_posp2, "Test11");
    temp_posp2->x = 9;
    temp_posp2->y = 9;
    DTAB_ADDH(dtab_test1, temp_posp2, "Test12");
    temp_posp2->x = 9;
    temp_posp2->y = 9;
    DTAB_ADDH(dtab_test1, temp_posp2, "Test13");
    temp_posp2->x = 9;
    temp_posp2->y = 9;
    DTAB_ADDH(dtab_test1, temp_posp2, "Test14");
    temp_posp2->x = 9;
    temp_posp2->y = 9;
    DTAB_ADDH(dtab_test1, temp_posp2, "Test15");
    temp_posp2->x = 9;
    temp_posp2->y = 9;
    DTAB_ADDH(dtab_test1, temp_posp2, "Test16");
    temp_posp2->x = 9;
    temp_posp2->y = 9;
    DTAB_ADDH(dtab_test1, temp_posp2, "Test17");
    temp_posp2->x = 9;
    temp_posp2->y = 9;
    DTAB_ADDH(dtab_test1, temp_posp2, "Test18");
...
#define REGISTER_ENUM(type) test_##type() {\
    ...
    lok(dtab_test1->len == DTAB_LEN_INIT);\
    uint64_t * temp_posp = DTAB_GETH(dtab_test1, "Test");\
    lok(temp_posp == NULL);\
    uint64_t tempval = 4;\
    DTAB_ADDH(dtab_test1, &tempval, "Test");\
    temp_posp = DTAB_GETH(dtab_test1, "Test");\
    lok(temp_posp != NULL);\
    ...
    lok(dtab_test2->len == DTAB_LEN_INIT);\
    temp_posp2 = 1;\
    DTAB_ADDH(dtab_test1, &temp_posp2, "Test31");\
    temp_posp2 = 2;\
    DTAB_ADDH(dtab_test1, &temp_posp2, "Test3");\
    temp_posp2 = 3;\
    DTAB_ADDH(dtab_test1, &temp_posp2, "Test4");\
